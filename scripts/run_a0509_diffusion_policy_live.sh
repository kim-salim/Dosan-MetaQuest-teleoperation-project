...
echo "Forcing Live OFF and MUX DISABLED before loading the Diffusion policy."
force_safe_state
...
echo "This script does not select LEROBOT or enable Live automatically."
...
taskset -c "${policy_cpu_set}" \
    ...
    --robot.id=a0509_diffusion_async_live \
